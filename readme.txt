=== Next Watermark ===
Contributors: nxtweb
Tags: copyright, signature, transparent, alpha, watermark, photo, picture, image, medias, upload, gallery
Requires at least: 5.3
Tested up to: 6.5
Stable tag: 1.7
Requires PHP: 7.3 and use of PHP GD script library.
License: GPLv3
License URI: https://www.gnu.org/licenses/gpl-3.0.html
Text Domain: next-watermark
Donate link: https://www.paypal.com/donate/?hosted_button_id=DRNEFMLP7CU5Q

Next Watermark helps you easily add automatically watermarks text or/and image type on your images (GIF, JPEG, PNG and WEBP formats supported)! Backup/restore at any time.
...
At Next Web, we can develop your future new website or plugins adapted to your needs.
Just contact us on: https://nxt-web.com/

== Installation ==
1. Upload the plugin files to the '/wp-content/plugins/next-watermark' directory, or install the plugin through the WordPress plugin screen directly.
3. Activate the plugin through the 'Plugins' screen in WordPress. PHP GD library is required on your server.
2. Go to Next Watermark menu to configure the plugin and save your changes.

== Frequently Asked Questions ==
= Why won't this work? =
It does work. If not just let me know! ;-)
Do not forget to apply your filter!

= Can I have both text and image watermarks on my images? =
...
= When I upload a new image to use as a watermark, is it automatically watermarked? =
No, this has been corrected since 1.2, so a new watermark is now not watermaked of course!

= How can I set a watermark on bottom right corner of all my images with different sizes? =
...
= If I uninstall the plugin, are watermarks removed from my images?
...
= Is it possible to restore my photos after watermarking? =
...
= Is it possible to restore only some images? =
...
== Screenshots ==
1. General Settings (1/2)
2. General Settings (2/2)
3. Watermark text options
4. Select Watermark image
5. Watermark image options
6. Backup/Restore options

== Changelog ==
= 1.7 =
* Php 8.2 empty image file bug fixed.
...
= 1.6.2 =
* Added Copy protection option.

= 1.6.1 =
* Minor bug fixes and improvements.

= 1.6 =
* Added mosaïc to repeat watermark text.

= 1.5 =
* Added WEBP support.
* Added fit to image heigth or width to image watermark, with keep aspect ratio option.
* French translation available.

= 1.4 =
* Added orientation on image watermark.
* Added preset positions to easily apply an image watermark.
* Plugin localization to WordPress native PO/MO format.

= 1.3 =
* Minor bug fixes and improvements.
* Added Backup/Restore service.
* You can add your own fonts.

= 1.2 =
* Added orientation and transparency on text watermark.
* Bug fix: upload of a new watermark logo is NOT automatically watermarked anymore!
* Added image formats option to select on which images the watermark can be applied.

= 1.1 =
* Added GIF format.
* Added custom theme or plugin image sizes support.
